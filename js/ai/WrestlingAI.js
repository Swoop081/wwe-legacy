import { moveEligibility, counterEligibility, autoCounterEligibility, canPlaySpecial, canPlayMomentum, canPlayAction, canPlaySupport, canPlayManager, canAttemptPin, submissionThreshold } from "../engine/rules.js?v=1.0.0";
import { healthRatio, healthZone, healthOnlyPinChance } from "../engine/health.js?v=1.0.0";
