import { moveEligibility, counterEligibility, autoCounterEligibility, canPlaySpecial, canPlayMomentum, canPlayAction, canPlayManager, canAttemptPin, submissionThreshold } from "../engine/rules.js?v=1.1.119";
import { healthRatio, healthZone, healthOnlyPinChance } from "../engine/health.js?v=1.1.119";
