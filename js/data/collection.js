...
import { CARD_NUMBER_MANIFEST, CARD_NUMBER_BY_ID, CARD_IDS_BY_SET } from "./card-number-manifest.js?v=1.1.23";
import { rewardPrintingTierForSet } from "./reward-printings.js?v=1.1.23";
