import { enrichCounterState } from "./counter-states.js?v=1.1.132";
import { rewardPrintingTierForSet } from "./reward-printings.js?v=1.1.132";
import { applyCardIdentityPass, finalizeCardIdentityPass } from "../shared/v1.1.69-card-identity-pass.js?v=1.1.132";
...
import { buildPremiereGameplayCards } from "./premiere-gameplay.js?v=1.1.220";
...
// LA Knight/Burning Hammer/Diving Elbow production behavior under canonical MITB IDs.
{
  ...
  const mitb=[
    ...
    {id:"MITB08",name:"LA Knight T-Shirt",kind:"merch",setId:"money-in-the-bank",cardCode:"MITB08",source:"money-in-the-bank",superstarId:"la-knight",rarity:3,boosterOnly:true,boosterEligible:true,deckEligible:false,consumable:true,rulesText:"Booster-only consumable. Boost LA Knight's primary Momentum for a limited number of matches.",effects:[{type:"boostPrimaryMomentumConsumable",printingStats:{base:{primaryMomentum:1,adrenaline:0,matches:1},emerald:{primaryMomentum:1,adrenaline:1,matches:2},sapphire:{primaryMomentum:2,adrenaline:0,matches:3},ruby:{primaryMomentum:2,adrenaline:1,matches:4},amethyst:{primaryMomentum:3,adrenaline:0,matches:5}}}]}
  ].filter(Boolean);
