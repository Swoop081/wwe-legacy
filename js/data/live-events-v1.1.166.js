...
// v1.1.200: NXT Series 1 is banked. No NXT event, hero, reward or themed opponent is launch-facing.
export const LIVE_EVENT_ROTATION_POOL = Object.freeze([
  ...
  E("womens-evolution","Women’s Evolution","WOMEN'S DIVISION","technical","becky-lynch","evolution-series-1","legacy",["becky-lynch","rhea-ripley","charlotte-flair","iyo-sky","bayley","paige","liv-morgan","chelsea-green"],"evolution"),
  ...
  E("submission-specialists","Submission Specialists","SUBMISSION SPECIALISTS","technical","kurt-angle","attitude-era-series-1","legacy",["kurt-angle","bret-hart","becky-lynch","cm-punk","gunther","rowdy-roddy-piper","eddie-guerrero"],"submission"),
  E("high-flyers","High Flyers","HIGH FLYERS","agility","rob-van-dam","ruthless-aggression-series-1","legacy",["rob-van-dam","jeff-hardy","rey-mysterio","iyo-sky","seth-rollins","logan-paul","liv-morgan"],"flyers"),
  E("power-houses","Power Houses","POWER HOUSES","strength","brock-lesnar","summerslam-series-1","legacy",["brock-lesnar","roman-reigns","gunther","batista","ultimate-warrior","diesel","kane"],"power"),
  E("monster-mayhem","Monster Mayhem","MONSTER MAYHEM","strength","kane","attitude-era-series-1","legacy",["kane","the-undertaker","brock-lesnar","andre-the-giant","yokozuna","diesel","batista"],"monster")
]);
...
export function rotatingLiveEventTemplates(now=new Date()){const start=(daySerial(now)*3)%LIVE_EVENT_ROTATION_POOL.length;return [0,1,2].map(i=>LIVE_EVENT_ROTATION_POOL[(start+i)%LIVE_EVENT_ROTATION_POOL.length]);}
