import { isUnreleasedSetId, isPlayerVisibleSuperstar } from "./release.js?v=1.1.99";
import { superstars } from "./superstars.js?v=1.1.99";
import { grantRandomBoosters } from "./boosters.js?v=1.1.99";
import { awardSeasonXp } from "./seasons.js?v=1.1.99";
