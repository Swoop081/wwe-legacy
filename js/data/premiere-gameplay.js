...
const aliases=Object.freeze({
 ...
 "PREM236":{id:"PREM236",name:"TOP ROPE POISONRANA",kind:"move",setId:"premiere",cost:7,damage:11,requirements:{agility:2},moveType:"aerial",method:"agility",superstarId:null,rarity:3,rulesText:"Standing opponent only. Grounds and Stuns opponent.",standingOnly:true,groundOpponent:true,groundedOnly:false,stun:1,selfDamage:0,effects:[],counterState:"diving-aerial",cardCode:"PREM236",source:"premiere"},
 "PREM234":{id:"PREM234",name:"THROW INTO THE RING STEPS",kind:"move",setId:"premiere",cost:5,damage:6,requirements:{strength:2},moveType:"grapple",method:"strength",superstarId:null,rarity:2,rulesText:"On Connect: opponent loses 1 Adrenaline and takes +1 persistent Body damage.",groundOpponent:false,groundedOnly:false,stun:0,selfDamage:0,effects:[{type:"adrenalineOpponent",amount:-1}],bodyDamage:{bodyPart:"body",pressure:1},counterState:"front-control",cardCode:"PREM234",source:"premiere"},
 "PREM231":{id:"PREM231",name:"SURFBOARD STRETCH",kind:"move",setId:"premiere",cost:5,damage:0,requirements:{technical:2},moveType:"submission",method:"technical",superstarId:null,rarity:2,rulesText:"Grounded opponent only. Submission. +4 persistent Back damage per successful turn.",groundOpponent:false,groundedOnly:true,stun:0,selfDamage:0,submission:{bodyPart:"back",pressure:4},effects:[],counterState:"torso-trapped",submissionTarget:"back",cardCode:"PREM231",source:"premiere"},
 "PREM228":{id:"PREM228",name:"SUNSET FLIP",kind:"move",setId:"premiere",cost:3,damage:3,requirements:{agility:1},moveType:"grapple",method:"agility",superstarId:null,rarity:1,rulesText:"Standing opponent only. On Connect: immediately attempt a Pin.",standingOnly:true,groundOpponent:false,groundedOnly:false,stun:0,selfDamage:0,effects:[{type:"pin",pinChanceBonus:0}],counterState:"body-elevated",cardCode:"PREM228",source:"premiere"},
 "PREM227":{id:"PREM227",name:"SUICIDE DIVE",kind:"move",setId:"premiere",cost:5,damage:6,requirements:{agility:2},moveType:"aerial",method:"agility",superstarId:null,rarity:2,rulesText:"On Connect: take 2 damage. Your next damaging Move gets +2 Damage.",groundOpponent:false,groundedOnly:false,stun:0,selfDamage:2,effects:[{type:"bonusNextDamagingMove",amount:2}],counterState:"running-aerial",cardCode:"PREM227",source:"premiere"},
 "PREM222":{id:"PREM222",name:"STANDING BOSTON CRAB",kind:"move",setId:"premiere",cost:5,damage:0,requirements:{technical:2},moveType:"submission",method:"technical",superstarId:null,rarity:2,rulesText:"Grounded opponent only. Submission. +4 persistent Leg damage per successful turn.",groundOpponent:false,groundedOnly:true,stun:0,selfDamage:0,submission:{bodyPart:"legs",pressure:4},effects:[],counterState:"leg-extended",submissionTarget:"legs",cardCode:"PREM222",source:"premiere"},
 "PREM221":{id:"PREM221",name:"STALLING SUPLEX",kind:"move",setId:"premiere",cost:5,damage:7,requirements:{strength:2},moveType:"grapple",method:"strength",superstarId:null,rarity:2,rulesText:"Grounds opponent.",groundOpponent:true,groundedOnly:false,stun:0,selfDamage:0,effects:[],counterState:"body-elevated",cardCode:"PREM221",source:"premiere"},
 "PREM218":{id:"PREM218",name:"SPEAR",kind:"move",setId:"premiere",cost:5,damage:7,requirements:{strength:2},moveType:"grapple",method:"strength",superstarId:null,rarity:2,rulesText:"Grounds opponent.",groundOpponent:true,groundedOnly:false,stun:0,selfDamage:0,finisher:false,effects:[],counterState:"torso-trapped",cardCode:"PREM218",source:"premiere"},
 "PREM216":{id:"PREM216",name:"SLINGSHOT CROSSBODY",kind:"move",setId:"premiere",cost:5,damage:7,requirements:{agility:2},moveType:"aerial",method:"agility",superstarId:null,rarity:2,rulesText:"Standing opponent only. Grounds opponent.",standingOnly:true,groundOpponent:true,groundedOnly:false,stun:0,selfDamage:0,effects:[],counterState:"diving-aerial",cardCode:"PREM216",source:"premiere"},
 "PREM213":{id:"PREM213",name:"SLAP",kind:"move",setId:"premiere",cost:1,damage:2,requirements:{strike:1},moveType:"strike",method:"strike",superstarId:null,rarity:1,rulesText:"May Counter an Arm Extended Move.",groundOpponent:false,groundedOnly:false,stun:0,selfDamage:0,effects:[],counterState:"arm-extended",counterStates:["arm-extended"],cardCode:"PREM213",source:"premiere"},
 ...
 "PREM208":{id:"PREM208",name:"SHOVE",kind:"move",setId:"premiere",cost:1,damage:1,requirements:{strike:1},moveType:"grapple",method:"strength",superstarId:null,rarity:1,rulesText:"",groundOpponent:false,groundedOnly:false,stun:0,selfDamage:0,effects:[],counterState:"torso-trapped",cardCode:"PREM208",source:"premiere"},
 ...
 "PREM191":{id:"PREM191",name:"ROARING ELBOW",kind:"move",setId:"premiere",cost:5,damage:7,requirements:{strike:2},moveType:"strike",method:"strike",superstarId:null,rarity:2,rulesText:"Stun 1.",groundOpponent:false,groundedOnly:false,stun:1,selfDamage:0,effects:[],counterState:"arm-extended",cardCode:"PREM191",source:"premiere"},
 "PREM190":{id:"PREM190",name:"POISONRANA",kind:"move",setId:"premiere",cost:6,damage:7,requirements:{agility:2},moveType:"grapple",method:"agility",superstarId:null,rarity:2,rulesText:"Standing opponent only. Grounds opponent. Stun 1.",standingOnly:true,groundOpponent:true,groundedOnly:false,stun:1,selfDamage:0,effects:[],counterState:"body-elevated",cardCode:"PREM190",source:"premiere"},
 ...
 "PREM145":{id:"PREM145",name:"ENZIGURI",kind:"move",setId:"premiere",cost:5,damage:7,requirements:{strike:2},moveType:"strike",method:"strike",superstarId:null,rarity:2,rulesText:"",groundOpponent:false,groundedOnly:false,stun:0,selfDamage:0,effects:[],counterState:"leg-extended",cardCode:"PREM145",source:"premiere"},
 "PREM144":{id:"PREM144",name:"ELECTRIC CHAIR DROP",kind:"move",setId:"premiere",cost:5,damage:8,requirements:{strength:2},moveType:"grapple",method:"strength",superstarId:null,rarity:3,rulesText:"",groundOpponent:false,groundedOnly:false,stun:0,selfDamage:0,effects:[],counterState:"front-control",cardCode:"PREM144",source:"premiere"},
 ...
 "PREM127":{id:"PREM127",name:"CHOKESLAM",kind:"move",setId:"premiere",cost:5,damage:9,requirements:{strength:2},moveType:"grapple",method:"strength",superstarId:null,rarity:3,rulesText:"Ground opponent.",groundOpponent:true,groundedOnly:false,stun:0,selfDamage:0,effects:[],counterState:"body-elevated",cardCode:"PREM127",source:"premiere"},
 ...
 "PREM97":{id:"PREM97",name:"ACKNOWLEDGE ME",kind:"action",setId:"premiere",cost:0,rarity:3,superstarId:"roman-reigns",maxCopies:2,rulesText:"Roman Reigns-exclusive Action. Gain +1 Adrenaline. Your next Roman Trademark this Control sequence cannot be Countered.",effect:{type:"premiereRomanAcknowledge",adrenaline:1,protectTrademark:true},cardCode:"PREM97",source:"premiere"},
 "PREM98":{id:"PREM98",name:"FINISH THE STORY",kind:"action",setId:"premiere",cost:0,rarity:3,superstarId:"cody-rhodes",maxCopies:2,rulesText:"Cody Rhodes-exclusive Action. Draw 2 pages. Your next Cody Trademark this Control sequence costs 2 less.",effect:{type:"premiereCodyFinishStory",draw:2,discountNextTrademark:2},cardCode:"PREM98",source:"premiere"},
 "PREM99":{id:"PREM99",name:"BEST IN THE WORLD",kind:"action",setId:"premiere",cost:0,rarity:3,superstarId:"cm-punk",maxCopies:2,rulesText:"CM Punk-exclusive Action. Draw 1 page and gain +1 Adrenaline. Your next Technical Move this Control sequence costs 2 less.",effect:{type:"premierePunkBestInWorld",draw:1,adrenaline:1,discountNextMethod:{method:"technical",amount:2}},cardCode:"PREM99",source:"premiere"},
 "PREM100":{id:"PREM100",name:"THE ARCHITECT",kind:"action",setId:"premiere",cost:0,rarity:3,superstarId:"seth-rollins",maxCopies:2,rulesText:"Seth Rollins-exclusive Action. Draw 2 pages. The next Move you play this Control sequence costs 2 less.",effect:{type:"premiereSethArchitect",draw:2,discountNextMove:2},cardCode:"PREM100",source:"premiere"},
 "PREM101":{id:"PREM101",name:"THE VIPER",kind:"action",setId:"premiere",cost:0,rarity:3,superstarId:"randy-orton",maxCopies:2,rulesText:"Randy Orton-exclusive Action. Search/draw RKO. It costs 3 less this Control sequence.",effect:{type:"search",name:"RKO",discount:3},cardCode:"PREM101",source:"premiere"},
 "PREM102":{id:"PREM102",name:"UNDERDOG FROM THE UNDERGROUND",kind:"action",setId:"premiere",cost:0,rarity:3,superstarId:"sami-zayn",maxCopies:2,rulesText:"Sami Zayn-exclusive Action. Draw 2 pages. If Sami has less HP than his opponent, gain +1 Adrenaline.",effect:{type:"premiereSamiUnderdog",draw:2,adrenalineIfBehind:1},cardCode:"PREM102",source:"premiere"},
 "PREM103":{id:"PREM103",name:"OPEN A CAN OF WHOOP ASS",kind:"action",setId:"premiere",cost:0,rarity:3,superstarId:"stone-cold-steve-austin",rulesText:"Stone Cold Steve Austin-exclusive Action. Your next Strike Move this Control sequence gets +3 Damage and cannot be Countered.",effect:{type:"premiereAustinWhoopAss",method:"strike",damage:3,uncounterable:true},cardCode:"PREM103",source:"premiere"},
 "PREM104":{id:"PREM104",name:"YOU CAN'T SEE ME",kind:"action",setId:"premiere",cost:0,rarity:3,superstarId:"john-cena",maxCopies:2,rulesText:"John Cena-exclusive Action. Search/draw Five Knuckle Shuffle. It costs 2 less this Control sequence. Gain +1 Adrenaline.",effect:{type:"premiereCenaCantSeeMe",name:"Five Knuckle Shuffle",discount:2,adrenaline:1},cardCode:"PREM104",source:"premiere"},
 "PREM105":{id:"PREM105",name:"MAMI KNOWS BEST",kind:"action",setId:"premiere",cost:0,rarity:3,superstarId:"rhea-ripley",maxCopies:2,rulesText:"Rhea Ripley-exclusive Action. Draw 1 page and gain +1 Adrenaline. Your next Strength Move this Control sequence costs 2 less.",effect:{type:"premiereRheaMami",draw:1,adrenaline:1,discountNextMethod:{method:"strength",amount:2}},cardCode:"PREM105",source:"premiere"},
 "PREM106":{id:"PREM106",name:"LIV & DOM",kind:"action",setId:"premiere",cost:0,rarity:3,superstarId:"liv-morgan",maxCopies:2,rulesText:"Liv Morgan-exclusive Action. Draw 2 pages, then ditch 1. Gain +1 Adrenaline.",effect:{type:"premiereLivAndDom",draw:2,discard:1,adrenaline:1},cardCode:"PREM106",source:"premiere"},
 "PREM107":{id:"PREM107",name:"BIG TIME BECKS",kind:"action",setId:"premiere",cost:0,rarity:3,superstarId:"becky-lynch",maxCopies:2,rulesText:"Becky Lynch-exclusive Action. Your next Trademark this Control sequence costs 2 less and gets +2 Damage.",effect:{type:"premiereBeckyBigTime",discountNextTrademark:2,damageNextTrademark:2},cardCode:"PREM107",source:"premiere"},
 "PREM108":{id:"PREM108",name:"WOOO",kind:"action",setId:"premiere",cost:0,rarity:3,superstarId:"charlotte-flair",maxCopies:2,rulesText:"Charlotte Flair-exclusive Action. Gain +1 Adrenaline. Your next Technical Move this Control sequence gets +2 Damage.",effect:{type:"premiereCharlotteWooo",adrenaline:1,method:"technical",damage:2},cardCode:"PREM108",source:"premiere"},
 "PREM109":{id:"PREM109",name:"THE CENTER OF THE UNIVERSE",kind:"action",setId:"premiere",cost:0,rarity:3,superstarId:"tiffany-stratton",maxCopies:2,rulesText:"Tiffany Stratton-exclusive Action. Draw 1 page. Your next Aerial Move this Control sequence costs 2 less and gets +2 Damage.",effect:{type:"premiereTiffanyCenter",draw:1,moveType:"aerial",discount:2,damage:2},cardCode:"PREM109",source:"premiere"},
 "PREM110":{id:"PREM110",name:"POINT TO THE SKY",kind:"action",setId:"premiere",cost:0,rarity:3,superstarId:"iyo-sky",maxCopies:2,rulesText:"IYO SKY-exclusive Action. Search/draw an Aerial Move. That Move costs 2 less this Control sequence.",effect:{type:"premiereIyoSky",searchMoveType:"aerial",discount:2},cardCode:"PREM110",source:"premiere"},
 "PREM111":{id:"PREM111",name:"LITTLE MISS BLISS",kind:"action",setId:"premiere",cost:0,rarity:3,superstarId:"alexa-bliss",maxCopies:2,rulesText:"Alexa Bliss-exclusive Action. Stun the opponent for 1. Your next Move this Control sequence costs 1 less.",effect:{type:"premiereAlexaBliss",stunOpponent:1,discountNextMove:1},cardCode:"PREM111",source:"premiere"},
 "PREM112":{id:"PREM112",name:"CANADA'S GREATEST EXPORT",kind:"action",setId:"premiere",cost:0,rarity:3,superstarId:"trish-stratus",maxCopies:2,rulesText:"Trish Stratus-exclusive Action. Draw 1 page and gain +1 Adrenaline. Your next Trademark this Control sequence costs 2 less.",effect:{type:"premiereTrishCanada",draw:1,adrenaline:1,discountNextTrademark:2},cardCode:"PREM112",source:"premiere"}
});
...
export function buildPremiereGameplayCards(cards=[]){
 ...
 "PREM43":{id:"PREM43",name:"DIS-ARM-HER",kind:"move",setId:"premiere",cost:9,damage:0,requirements:{},moveType:"submission",method:null,superstarId:"becky-lynch",rarity:4,rulesText:"Becky Lynch-exclusive Finisher. Grounded opponent only. Submission. +7 persistent Arm damage per successful turn.",groundOpponent:false,groundedOnly:true,stun:0,selfDamage:0,submission:{bodyPart:"arms",pressure:7},finisher:true,effects:[],counterState:"front-control",submissionTarget:"arms",cardCode:"PREM43",source:"premiere"},
 "PREM47":{id:"PREM47",name:"SISTER ABIGAIL",kind:"move",setId:"premiere",cost:9,damage:16,requirements:{},moveType:"grapple",method:null,superstarId:"alexa-bliss",rarity:4,rulesText:"Alexa Bliss-exclusive Finisher. No Method requirement. Grounds opponent. Stun 1.",groundOpponent:true,groundedOnly:false,stun:1,selfDamage:0,finisher:true,effects:[],counterState:"front-control",cardCode:"PREM47",source:"premiere"},
 "PREM49":{id:"PREM49",name:"SUPERMAN PUNCH",kind:"move",setId:"premiere",cost:7,damage:10,requirements:{strike:2},moveType:"strike",method:"strike",superstarId:"roman-reigns",rarity:3,rulesText:"Roman Reigns-exclusive Trademark. Grounds opponent. On Connect: search/draw ROMAN'S SPEAR.",groundOpponent:true,groundedOnly:false,stun:0,selfDamage:0,trademark:true,effects:[{type:"search",name:"ROMAN'S SPEAR"}],counterState:"arm-extended",cardCode:"PREM49",source:"premiere"},
 "PREM50":{id:"PREM50",name:"GUILLOTINE",kind:"move",setId:"premiere",cost:7,damage:0,requirements:{strength:2},moveType:"submission",method:"strength",superstarId:"roman-reigns",rarity:3,rulesText:"Roman Reigns-exclusive Trademark. Submission. +3 persistent Head damage per successful turn.",groundOpponent:false,groundedOnly:false,stun:0,selfDamage:0,submission:{bodyPart:"head",pressure:3},trademark:true,effects:[],counterState:"body-elevated",submissionTarget:"neck-head",cardCode:"PREM50",source:"premiere"},
 "PREM51":{id:"PREM51",name:"DRIVE-BY",kind:"move",setId:"premiere",cost:5,damage:8,requirements:{strike:2},moveType:"strike",method:"strike",superstarId:"roman-reigns",rarity:3,rulesText:"Roman Reigns-exclusive Trademark. Grounded opponent only. Stun 1.",groundOpponent:true,groundedOnly:true,stun:1,selfDamage:0,trademark:true,effects:[],counterState:"leg-extended",cardCode:"PREM51",source:"premiere"},
 "PREM52":{id:"PREM52",name:"CODY CUTTER",kind:"move",setId:"premiere",cost:7,damage:12,requirements:{technical:1,agility:1},moveType:"grapple",method:"technical",superstarId:"cody-rhodes",rarity:3,rulesText:"Cody Rhodes-exclusive Trademark. Grounds opponent. On Connect: search/draw CROSS RHODES; it costs 3 less this Control sequence.",groundOpponent:true,groundedOnly:false,stun:0,selfDamage:0,trademark:true,effects:[{type:"search",name:"CROSS RHODES",discount:3}],counterState:"running-aerial",cardCode:"PREM52",source:"premiere"},
 "PREM53":{id:"PREM53",name:"DISASTER KICK",kind:"move",setId:"premiere",cost:5,damage:9,requirements:{strike:1,agility:1},moveType:"strike",method:"strike",superstarId:"cody-rhodes",rarity:3,rulesText:"Cody Rhodes-exclusive Trademark. On Connect: gain +1 Adrenaline.",groundOpponent:false,groundedOnly:false,stun:0,selfDamage:0,trademark:true,effects:[{type:"gainAdrenaline",amount:1}],counterState:"leg-extended",cardCode:"PREM53",source:"premiere"},
 "PREM54":{id:"PREM54",name:"BIONIC ELBOW",kind:"move",setId:"premiere",cost:4,damage:6,requirements:{strike:2},moveType:"strike",method:"strike",superstarId:"cody-rhodes",rarity:3,rulesText:"Cody Rhodes-exclusive Trademark. On Connect: gain +1 Adrenaline.",groundOpponent:false,groundedOnly:false,stun:0,selfDamage:0,trademark:true,effects:[{type:"gainAdrenaline",amount:1}],counterState:"arm-extended",cardCode:"PREM54",source:"premiere"},
 "PREM55":{id:"PREM55",name:"ANACONDA VISE",kind:"move",setId:"premiere",cost:7,damage:0,requirements:{technical:2},moveType:"submission",method:"technical",superstarId:"cm-punk",rarity:3,rulesText:"CM Punk-exclusive Trademark. Grounded opponent only. Submission. +5 persistent Head damage per successful turn. On Connect: draw 1 page.",groundOpponent:true,groundedOnly:true,stun:0,selfDamage:0,submission:{bodyPart:"head",pressure:5},trademark:true,effects:[{type:"drawSelf",amount:1}],counterState:"front-control",submissionTarget:"neck-head",cardCode:"PREM55",source:"premiere"},
 "PREM56":{id:"PREM56",name:"RUNNING HIGH KNEE",kind:"move",setId:"premiere",cost:6,damage:9,requirements:{strike:2},moveType:"strike",method:"strike",superstarId:"cm-punk",rarity:3,rulesText:"CM Punk-exclusive Trademark. Stun 1. On Connect: search/draw BULLDOG.",groundOpponent:false,groundedOnly:false,stun:1,selfDamage:0,trademark:true,effects:[{type:"search",name:"BULLDOG",discount:0}],counterState:"leg-extended",cardCode:"PREM56",source:"premiere"},
 "PREM57":{id:"PREM57",name:"DIVING ELBOW DROP",kind:"move",setId:"premiere",cost:6,damage:10,requirements:{agility:1,strike:1},moveType:"aerial",method:"agility",superstarId:"cm-punk",rarity:3,rulesText:"CM Punk-exclusive Trademark. Grounded opponent only. On Connect: +1 persistent Head damage.",groundOpponent:true,groundedOnly:true,stun:0,selfDamage:0,trademark:true,effects:[],counterState:"diving-aerial",bodyDamage:{bodyPart:"head",pressure:1},cardCode:"PREM57",source:"premiere"},
 "PREM58":{id:"PREM58",name:"PEDIGREE",kind:"move",setId:"premiere",cost:7,damage:11,requirements:{technical:2},moveType:"grapple",method:"technical",superstarId:"seth-rollins",rarity:3,rulesText:"Seth Rollins-exclusive Trademark. Grounds opponent.",groundOpponent:true,groundedOnly:false,stun:0,selfDamage:0,trademark:true,effects:[],counterState:"front-control",cardCode:"PREM58",source:"premiere"},
 "PREM59":{id:"PREM59",name:"PHOENIX SPLASH",kind:"move",setId:"premiere",cost:8,damage:12,requirements:{agility:2},moveType:"aerial",method:"agility",superstarId:"seth-rollins",rarity:3,rulesText:"Seth Rollins-exclusive Trademark. Grounded opponent only.",groundOpponent:true,groundedOnly:true,stun:0,selfDamage:0,trademark:true,effects:[],counterState:"diving-aerial",cardCode:"PREM59",source:"premiere"},
 "PREM60":{id:"PREM60",name:"FALCON ARROW",kind:"move",setId:"premiere",cost:5,damage:8,requirements:{technical:2},moveType:"grapple",method:"technical",superstarId:"seth-rollins",rarity:3,rulesText:"Seth Rollins-exclusive Trademark. Grounds opponent.",groundOpponent:true,groundedOnly:false,stun:0,selfDamage:0,trademark:true,effects:[],counterState:"body-elevated",cardCode:"PREM60",source:"premiere"},
 "PREM61":{id:"PREM61",name:"THE PUNT",kind:"move",setId:"premiere",cost:9,damage:13,requirements:{strike:2},moveType:"strike",method:"strike",superstarId:"randy-orton",rarity:3,rulesText:"Randy Orton-exclusive Trademark. 13 Damage at Base.",groundOpponent:false,groundedOnly:false,stun:0,selfDamage:0,trademark:true,effects:[],counterState:"leg-extended",cardCode:"PREM61",source:"premiere"},
 "PREM62":{id:"PREM62",name:"DRAPING DDT",kind:"move",setId:"premiere",cost:7,damage:10,requirements:{technical:2},moveType:"grapple",method:"technical",superstarId:"randy-orton",rarity:3,rulesText:"Randy Orton-exclusive Trademark. Grounds opponent. On Connect: search/draw RKO; it costs 3 less this Control sequence. On Connect: +1 persistent Head damage.",groundOpponent:true,groundedOnly:false,stun:0,selfDamage:0,trademark:true,effects:[{type:"search",name:"RKO",discount:3}],bodyDamage:{bodyPart:"head",pressure:1},counterState:"front-control",cardCode:"PREM62",source:"premiere"},

 "PREM63":{id:"PREM63",name:"SCOOP POWERSLAM",kind:"move",setId:"premiere",cost:6,damage:9,requirements:{technical:2},moveType:"grapple",method:"technical",superstarId:"randy-orton",rarity:3,rulesText:"Randy Orton-exclusive Trademark. Grounds opponent. On Connect: draw 1 page and gain +1 Adrenaline.",groundOpponent:true,groundedOnly:false,stun:0,selfDamage:0,trademark:true,effects:[{type:"drawSelf",amount:1},{type:"gainAdrenaline",amount:1}],counterState:"torso-trapped",cardCode:"PREM63",source:"premiere"},
 "PREM64":{id:"PREM64",name:"BLUE THUNDER BOMB",kind:"move",setId:"premiere",cost:6,damage:11,requirements:{technical:2},moveType:"grapple",method:"technical",superstarId:"sami-zayn",rarity:3,rulesText:"Sami Zayn-exclusive Trademark. Standing opponent only. Grounds opponent. On Connect: draw 1 page. If Sami has less HP than his opponent, also gain +1 Adrenaline.",groundOpponent:true,groundedOnly:false,standingOnly:true,stun:0,selfDamage:0,trademark:true,effects:[{type:"drawSelf",amount:1},{type:"gainAdrenalineIfBehind",amount:1}],counterState:"body-elevated",cardCode:"PREM64",source:"premiere"},
 "PREM65":{id:"PREM65",name:"EXPLODER SUPLEX",kind:"move",setId:"premiere",cost:6,damage:9,requirements:{technical:2},moveType:"grapple",method:"technical",superstarId:"sami-zayn",rarity:3,rulesText:"Sami Zayn-exclusive Trademark. Grounds opponent. On Connect: draw 1 page.",groundOpponent:true,groundedOnly:false,stun:0,selfDamage:0,trademark:true,effects:[{type:"drawSelf",amount:1}],counterState:"torso-trapped",cardCode:"PREM65",source:"premiere"},
 "PREM66":{id:"PREM66",name:"YAKUZA KICK",kind:"move",setId:"premiere",cost:6,damage:9,requirements:{strike:1,agility:1},moveType:"strike",method:"strike",superstarId:"sami-zayn",rarity:3,rulesText:"Sami Zayn-exclusive Trademark. Standing opponent only. Grounds opponent. On Connect: opponent loses 1 Adrenaline.",groundOpponent:true,groundedOnly:false,standingOnly:true,stun:0,selfDamage:0,trademark:true,effects:[{type:"loseOpponentAdrenaline",amount:1}],counterState:"leg-extended",cardCode:"PREM66",source:"premiere"},
 "PREM72":{id:"PREM72",name:"DIVING SHOULDER TACKLE",kind:"move",setId:"premiere",cost:5,damage:8,requirements:{strength:2},moveType:"aerial",method:"strength",superstarId:"john-cena",rarity:3,rulesText:"John Cena-exclusive Trademark. Standing opponent only. Grounds opponent. On Connect: search/draw Five Knuckle Shuffle; it costs 1 less this Control sequence.",groundOpponent:true,groundedOnly:false,standingOnly:true,stun:0,selfDamage:0,trademark:true,effects:[{type:"search",name:"Five Knuckle Shuffle",discount:1}],counterState:"diving-aerial",cardCode:"PREM72",source:"premiere"},
 "PREM75":{id:"PREM75",name:"MISSILE DROPKICK",kind:"move",setId:"premiere",cost:6,damage:10,requirements:{strike:1,agility:1},moveType:"aerial",method:"agility",superstarId:"rhea-ripley",rarity:3,rulesText:"Rhea Ripley-exclusive Trademark. Standing opponent only. Grounds opponent. On Connect: gain +1 Adrenaline.",groundOpponent:true,groundedOnly:false,standingOnly:true,stun:0,selfDamage:0,trademark:true,effects:[{type:"gainAdrenaline",amount:1}],counterState:"diving-aerial",cardCode:"PREM75",source:"premiere"},
 "PREM77":{id:"PREM77",name:"COMPLETE SHOT",kind:"move",setId:"premiere",cost:5,damage:9,requirements:{agility:1,technical:1},moveType:"grapple",method:"technical",superstarId:"liv-morgan",rarity:3,rulesText:"Liv Morgan-exclusive Trademark. Flatliner-style takedown. Grounds opponent. On Connect: draw 1 page.",groundOpponent:true,groundedOnly:false,stun:0,selfDamage:0,trademark:true,effects:[{type:"drawSelf",amount:1}],counterState:"front-control",cardCode:"PREM77",source:"premiere"},
 ...
 for(const [id,name,sid] of SPECIFIC){if(authoredSpecific[id]){out.push(structuredClone(authoredSpecific[id]));continue;}let base=exactLegacySourceIds[id]?sourceById.get(exactLegacySourceIds[id]):find(name,sid);if(!base&&id==="PREM58")base=find("Seth Rollins Pedigree",sid)||find("Pedigree");if(!base)continue;const cloned={...structuredClone(base),id,name,setId:"premiere",superstarId:sid,cardCode:id,source:"premiere"};if(id==="PREM67"){cloned.requirements={strike:1,strength:1};cloned.method="strike";cloned.trademark=true;cloned.rulesText=String(cloned.rulesText??"").replace(/Mounted Punches/gi,"Grounded Punches");if(cloned.effects)cloned.effects=cloned.effects.map(effect=>({...effect,name:effect.name&&/mounted punches/i.test(effect.name)?"GROUNDED PUNCHES":effect.name}));}if(id==="PREM68"){cloned.requirements={strike:2};cloned.method="strike";cloned.trademark=true;}if(id==="PREM69"){cloned.requirements={strike:2};cloned.method="strike";cloned.trademark=true;}if(id==="PREM70"){cloned.requirements={strike:1,strength:1};cloned.method="strike";cloned.trademark=true;}if(id==="PREM71"){cloned.requirements={technical:1,strength:1};cloned.method="technical";}if(id==="PREM38"){cloned.standingChainAfter="EXPLODER SUPLEX";cloned.discountIfNamedConnectedThisControl={name:"EXPLODER SUPLEX",amount:2};delete cloned.discountIfMethodConnectedThisControl;cloned.rulesText="Sami Zayn-exclusive Finisher. Standing opponent only, except after EXPLODER SUPLEX this Control sequence. Grounds opponent. If EXPLODER SUPLEX connected earlier this Control sequence, costs 2 less.";}if(id==="PREM71"){cloned.rarity=3;cloned.trademark=true;delete cloned.finisher;cloned.rulesText=cloned.rulesText.replace("John Cena-exclusive Finisher.","John Cena-exclusive Trademark.");}if(id==="PREM73"){cloned.requirements={strength:2};cloned.method="strength";cloned.trademark=true;}if(id==="PREM74"){cloned.rarity=3;cloned.trademark=true;cloned.requirements={strength:2};cloned.method="strength";cloned.rulesText="Rhea Ripley-exclusive Trademark.";cloned.groundOpponent=true;}if(id==="PREM76"){cloned.requirements={strike:2};cloned.method="strike";cloned.trademark=true;}if(id==="PREM81"){cloned.requirements={strike:1,agility:1};cloned.method="agility";cloned.trademark=true;}if(id==="PREM82"){cloned.requirements={technical:2};cloned.method="technical";cloned.trademark=true;}if(id==="PREM83"){cloned.requirements={strike:1,agility:1};cloned.method="agility";cloned.trademark=true;}if(id==="PREM84"){cloned.requirements={strike:2};cloned.method="strike";cloned.trademark=true;}if(id==="PREM86"){cloned.requirements={agility:2};cloned.method="agility";cloned.trademark=true;}if(id==="PREM88"){cloned.requirements={agility:1,technical:1};cloned.method="agility";cloned.trademark=true;}if(id==="PREM90"){cloned.requirements={agility:2};cloned.method="agility";cloned.trademark=true;}if(id==="PREM91"){cloned.requirements={agility:2};cloned.method="agility";cloned.trademark=true;}if(id==="PREM92"){cloned.requirements={strike:1,technical:1};cloned.method="technical";cloned.trademark=true;}if(id==="PREM93"){cloned.requirements={agility:1,strike:1};cloned.method="agility";cloned.trademark=true;}if(id==="PREM94"){cloned.requirements={strike:2};cloned.method="strike";cloned.trademark=true;}if(id==="PREM95"){cloned.requirements={agility:1,technical:1};cloned.method="agility";cloned.trademark=true;}if(id==="PREM96"){cloned.requirements={strike:1,agility:1};cloned.method="agility";cloned.trademark=true;}if(["PREM33","PREM34","PREM35","PREM36","PREM37","PREM38","PREM39","PREM40","PREM41","PREM42","PREM45","PREM46","PREM48"].includes(id)){cloned.damage=16;cloned.cost=9;}if(id==="PREM44"){cloned.cost=9;if(cloned.submission)cloned.submission.pressure=7;}out.push(cloned);}
 ...
 out.push(
  {id:"PREM271",name:"STRIKE MOMENTUM",kind:"momentum",type:"momentum",setId:"premiere",cardCode:"PREM271",source:"premiere",momentumType:"strike",rarity:1,cost:0,damage:0,requirements:{},rulesText:"Gain 1 Strike Momentum.",effects:[{type:"gainAttributeMomentum",attribute:"strike",amount:1}],boosterEligible:false},
  {id:"PREM272",name:"STRENGTH MOMENTUM",kind:"momentum",type:"momentum",setId:"premiere",cardCode:"PREM272",source:"premiere",momentumType:"strength",rarity:1,cost:0,damage:0,requirements:{},rulesText:"Gain 1 Strength Momentum.",effects:[{type:"gainAttributeMomentum",attribute:"strength",amount:1}],boosterEligible:false},
