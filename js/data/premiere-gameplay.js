...
\nexport function buildPremiereGameplayCards(cards=[]){
 ...
 "PREM47":{id:"PREM47",name:"SISTER ABIGAIL",kind:"move",setId:"premiere",cost:8,damage:15,requirements:{},moveType:"grapple",method:null,superstarId:"alexa-bliss",rarity:4,rulesText:"Alexa Bliss-exclusive Finisher. No Method requirement. Grounds opponent. On connect, search/draw Twisted Bliss; that searched Twisted Bliss costs 3 less during the current Control sequence.",groundOpponent:true,groundedOnly:false,stun:1,selfDamage:0,finisher:true,effects:[{type:"search",name:"Twisted Bliss",discount:3}],counterState:"front-control",cardCode:"PREM47",source:"premiere"},
