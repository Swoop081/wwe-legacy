...
const aliases=Object.freeze({
 ...
 "PREM97":{id:"PREM97",name:"ACKNOWLEDGE ME",kind:"action",setId:"premiere",cost:0,rarity:4,superstarId:"roman-reigns",maxCopies:1,rulesText:"Roman Reigns-exclusive Action. Gain +1 Adrenaline. Your next Roman Trademark this Control sequence cannot be Countered.",effect:{type:"premiereRomanAcknowledge",adrenaline:1,protectTrademark:true},cardCode:"PREM97",source:"premiere"},
 "PREM98":{id:"PREM98",name:"FINISH THE STORY",kind:"action",setId:"premiere",cost:0,rarity:4,superstarId:"cody-rhodes",maxCopies:1,rulesText:"Cody Rhodes-exclusive Action. Draw 2 pages. Your next Cody Trademark this Control sequence costs 2 less.",effect:{type:"premiereCodyFinishStory",draw:2,discountNextTrademark:2},cardCode:"PREM98",source:"premiere"},
 "PREM99":{id:"PREM99",name:"BEST IN THE WORLD",kind:"action",setId:"premiere",cost:0,rarity:4,superstarId:"cm-punk",maxCopies:1,rulesText:"CM Punk-exclusive Action. Draw 1 page and gain +1 Adrenaline. Your next Technical Move this Control sequence costs 2 less.",effect:{type:"premierePunkBestInWorld",draw:1,adrenaline:1,discountNextMethod:{method:"technical",amount:2}},cardCode:"PREM99",source:"premiere"},
 "PREM100":{id:"PREM100",name:"THE ARCHITECT",kind:"action",setId:"premiere",cost:0,rarity:4,superstarId:"seth-rollins",maxCopies:1,rulesText:"Seth Rollins-exclusive Action. Draw 2 pages. The next Move you play this Control sequence costs 2 less.",effect:{type:"premiereSethArchitect",draw:2,discountNextMove:2},cardCode:"PREM100",source:"premiere"},
 "PREM101":{id:"PREM101",name:"THE VIPER",kind:"action",setId:"premiere",cost:0,rarity:4,superstarId:"randy-orton",maxCopies:1,rulesText:"Randy Orton-exclusive Action. Search/draw RKO. It costs 3 less this Control sequence.",effect:{type:"search",name:"RKO",discount:3},cardCode:"PREM101",source:"premiere"},
 "PREM102":{id:"PREM102",name:"UNDERDOG FROM THE UNDERGROUND",kind:"action",setId:"premiere",cost:0,rarity:4,superstarId:"sami-zayn",maxCopies:1,rulesText:"Sami Zayn-exclusive Action. Draw 2 pages. If Sami has less HP than his opponent, gain +1 Adrenaline.",effect:{type:"premiereSamiUnderdog",draw:2,adrenalineIfBehind:1},cardCode:"PREM102",source:"premiere"},
 "PREM103":{id:"PREM103",name:"OPEN A CAN OF WHOOP ASS",kind:"action",setId:"premiere",cost:0,rarity:4,superstarId:"stone-cold-steve-austin",maxCopies:1,rulesText:"Stone Cold Steve Austin-exclusive Action. Your next Strike Move this Control sequence gets +3 Damage and cannot be Countered.",effect:{type:"premiereAustinWhoopAss",method:"strike",damage:3,uncounterable:true},cardCode:"PREM103",source:"premiere"},
 "PREM104":{id:"PREM104",name:"YOU CAN'T SEE ME",kind:"action",setId:"premiere",cost:0,rarity:4,superstarId:"john-cena",maxCopies:1,rulesText:"John Cena-exclusive Action. Search/draw Five Knuckle Shuffle. It costs 2 less this Control sequence. Gain +1 Adrenaline.",effect:{type:"premiereCenaCantSeeMe",name:"Five Knuckle Shuffle",discount:2,adrenaline:1},cardCode:"PREM104",source:"premiere"},
 "PREM105":{id:"PREM105",name:"MAMI KNOWS BEST",kind:"action",setId:"premiere",cost:0,rarity:4,superstarId:"rhea-ripley",maxCopies:1,rulesText:"Rhea Ripley-exclusive Action. Draw 1 page and gain +1 Adrenaline. Your next Strength Move this Control sequence costs 2 less.",effect:{type:"premiereRheaMami",draw:1,adrenaline:1,discountNextMethod:{method:"strength",amount:2}},cardCode:"PREM105",source:"premiere"},
 "PREM106":{id:"PREM106",name:"LIV & DOM",kind:"action",setId:"premiere",cost:0,rarity:4,superstarId:"liv-morgan",maxCopies:1,rulesText:"Liv Morgan-exclusive Action. Draw 2 pages, then ditch 1. Gain +1 Adrenaline.",effect:{type:"premiereLivAndDom",draw:2,discard:1,adrenaline:1},cardCode:"PREM106",source:"premiere"},
 "PREM107":{id:"PREM107",name:"BIG TIME BECKS",kind:"action",setId:"premiere",cost:0,rarity:4,superstarId:"becky-lynch",maxCopies:1,rulesText:"Becky Lynch-exclusive Action. Your next Trademark this Control sequence costs 2 less and gets +2 Damage.",effect:{type:"premiereBeckyBigTime",discountNextTrademark:2,damageNextTrademark:2},cardCode:"PREM107",source:"premiere"},
 "PREM108":{id:"PREM108",name:"WOOO",kind:"action",setId:"premiere",cost:0,rarity:4,superstarId:"charlotte-flair",maxCopies:1,rulesText:"Charlotte Flair-exclusive Action. Gain +1 Adrenaline. Your next Technical Move this Control sequence gets +2 Damage.",effect:{type:"premiereCharlotteWooo",adrenaline:1,method:"technical",damage:2},cardCode:"PREM108",source:"premiere"},
 "PREM109":{id:"PREM109",name:"THE CENTER OF THE UNIVERSE",kind:"action",setId:"premiere",cost:0,rarity:4,superstarId:"tiffany-stratton",maxCopies:1,rulesText:"Tiffany Stratton-exclusive Action. Draw 1 page. Your next Aerial Move this Control sequence costs 2 less and gets +2 Damage.",effect:{type:"premiereTiffanyCenter",draw:1,moveType:"aerial",discount:2,damage:2},cardCode:"PREM109",source:"premiere"},
 "PREM110":{id:"PREM110",name:"POINT TO THE SKY",kind:"action",setId:"premiere",cost:0,rarity:4,superstarId:"iyo-sky",maxCopies:1,rulesText:"IYO SKY-exclusive Action. Search/draw an Aerial Move. That Move costs 2 less this Control sequence.",effect:{type:"premiereIyoSky",searchMoveType:"aerial",discount:2},cardCode:"PREM110",source:"premiere"},
 "PREM111":{id:"PREM111",name:"LITTLE MISS BLISS",kind:"action",setId:"premiere",cost:0,rarity:4,superstarId:"alexa-bliss",maxCopies:1,rulesText:"Alexa Bliss-exclusive Action. Stun the opponent for 1. Your next Move this Control sequence costs 1 less.",effect:{type:"premiereAlexaBliss",stunOpponent:1,discountNextMove:1},cardCode:"PREM111",source:"premiere"},
 "PREM112":{id:"PREM112",name:"CANADA'S GREATEST EXPORT",kind:"action",setId:"premiere",cost:0,rarity:4,superstarId:"trish-stratus",maxCopies:1,rulesText:"Trish Stratus-exclusive Action. Draw 1 page and gain +1 Adrenaline. Your next Trademark this Control sequence costs 2 less.",effect:{type:"premiereTrishCanada",draw:1,adrenaline:1,discountNextTrademark:2},cardCode:"PREM112",source:"premiere"}
});
