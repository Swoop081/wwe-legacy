import { superstars } from "./superstars.js?v=1.1.352";
import { collectionCards } from "./collection.js?v=1.1.352";
import { grantStoreSuperstarUnlockPackage, hasSuperstar, spendUniversePoints } from "./profile.js?v=1.1.352";
import { isPlayerReleasedSetId } from "./release.js?v=1.1.352";
