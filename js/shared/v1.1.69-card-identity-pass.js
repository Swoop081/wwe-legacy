...
const APPROVED_AUDIT_OVERRIDES = Object.freeze({
  // SUBMISSION_FIVE_TIER_PASS_V11220 — submissions stay at 0 direct damage; higher tiers improve play efficiency through lower cost while preserving authored pressure/effects.
  'mankind-mandible-claw': {printingStats:{base:{cost:11,damage:0},emerald:{cost:10,damage:0},sapphire:{cost:9,damage:0},ruby:{cost:8,damage:0},amethyst:{cost:7,damage:0}}},
  'bearhug': {printingStats:{base:{cost:7,damage:0},emerald:{cost:6,damage:0},sapphire:{cost:5,damage:0},ruby:{cost:4,damage:0},amethyst:{cost:3,damage:0}}},
  'crossface': {printingStats:{base:{cost:8,damage:0},emerald:{cost:7,damage:0},sapphire:{cost:6,damage:0},ruby:{cost:5,damage:0},amethyst:{cost:4,damage:0}}},
  'koji-clutch': {printingStats:{base:{cost:8,damage:0},emerald:{cost:7,damage:0},sapphire:{cost:6,damage:0},ruby:{cost:5,damage:0},amethyst:{cost:4,damage:0}}},
  'cm-punk-anaconda-vise': {printingStats:{base:{cost:9,damage:0},emerald:{cost:8,damage:0},sapphire:{cost:7,damage:0},ruby:{cost:6,damage:0},amethyst:{cost:5,damage:0}}},
  'paige-pto': {printingStats:{base:{cost:9,damage:0},emerald:{cost:8,damage:0},sapphire:{cost:7,damage:0},ruby:{cost:6,damage:0},amethyst:{cost:5,damage:0}}},
  'andre-the-giant-bear-hug': {printingStats:{base:{cost:9,damage:0},emerald:{cost:8,damage:0},sapphire:{cost:7,damage:0},ruby:{cost:6,damage:0},amethyst:{cost:5,damage:0}}},
  'figure-four-leglock': {printingStats:{base:{cost:8,damage:0},emerald:{cost:7,damage:0},sapphire:{cost:6,damage:0},ruby:{cost:5,damage:0},amethyst:{cost:4,damage:0}}},
  'charlotte-flair-figure-eight-leglock': {printingStats:{base:{cost:11,damage:0},emerald:{cost:10,damage:0},sapphire:{cost:9,damage:0},ruby:{cost:8,damage:0},amethyst:{cost:7,damage:0}}},
  'rhea-ripley-prism-trap': {printingStats:{base:{cost:9,damage:0},emerald:{cost:8,damage:0},sapphire:{cost:7,damage:0},ruby:{cost:6,damage:0},amethyst:{cost:5,damage:0}}},
  'brock-lesnar-kimura-lock': {printingStats:{base:{cost:9,damage:0},emerald:{cost:8,damage:0},sapphire:{cost:7,damage:0},ruby:{cost:6,damage:0},amethyst:{cost:5,damage:0}}},
  'boston-crab': {printingStats:{base:{cost:7,damage:0},emerald:{cost:6,damage:0},sapphire:{cost:5,damage:0},ruby:{cost:4,damage:0},amethyst:{cost:3,damage:0}}},
  'gunther-gojira-clutch': {printingStats:{base:{cost:11,damage:0},emerald:{cost:10,damage:0},sapphire:{cost:9,damage:0},ruby:{cost:8,damage:0},amethyst:{cost:7,damage:0}}},
  'stf': {printingStats:{base:{cost:7,damage:0},emerald:{cost:6,damage:0},sapphire:{cost:5,damage:0},ruby:{cost:4,damage:0},amethyst:{cost:3,damage:0}}},
  'abdominal-stretch': {printingStats:{base:{cost:6,damage:0},emerald:{cost:5,damage:0},sapphire:{cost:4,damage:0},ruby:{cost:3,damage:0},amethyst:{cost:2,damage:0}}},
  'chad-gable-ankle-lock': {printingStats:{base:{cost:11,damage:0},emerald:{cost:10,damage:0},sapphire:{cost:9,damage:0},ruby:{cost:8,damage:0},amethyst:{cost:7,damage:0}}},
  'mexican-surfboard': {printingStats:{base:{cost:7,damage:0},emerald:{cost:6,damage:0},sapphire:{cost:5,damage:0},ruby:{cost:4,damage:0},amethyst:{cost:3,damage:0}}},
  'octopus-hold': {printingStats:{base:{cost:7,damage:0},emerald:{cost:6,damage:0},sapphire:{cost:5,damage:0},ruby:{cost:4,damage:0},amethyst:{cost:3,damage:0}}},
  'joe-hendry-hendry-lock': {printingStats:{base:{cost:8,damage:0},emerald:{cost:7,damage:0},sapphire:{cost:6,damage:0},ruby:{cost:5,damage:0},amethyst:{cost:4,damage:0}}},
  'roxanne-perez-rok-lock': {printingStats:{base:{cost:8,damage:0},emerald:{cost:7,damage:0},sapphire:{cost:6,damage:0},ruby:{cost:5,damage:0},amethyst:{cost:4,damage:0}}},
  'hangman-armbar': {printingStats:{base:{cost:5,damage:0},emerald:{cost:4,damage:0},sapphire:{cost:3,damage:0},ruby:{cost:2,damage:0},amethyst:{cost:1,damage:0}}},
  'lola-vice-triangle-choke': {printingStats:{base:{cost:8,damage:0},emerald:{cost:7,damage:0},sapphire:{cost:6,damage:0},ruby:{cost:5,damage:0},amethyst:{cost:4,damage:0}}},
  'mr-iguana-muta-lock': {printingStats:{base:{cost:8,damage:0},emerald:{cost:7,damage:0},sapphire:{cost:6,damage:0},ruby:{cost:5,damage:0},amethyst:{cost:4,damage:0}}},
  'bret-hart-ringpost-figure-four': {printingStats:{base:{cost:8,damage:0},emerald:{cost:7,damage:0},sapphire:{cost:6,damage:0},ruby:{cost:5,damage:0},amethyst:{cost:4,damage:0}}},
  'bret-hart-sharpshooter': {printingStats:{base:{cost:11,damage:0},emerald:{cost:10,damage:0},sapphire:{cost:9,damage:0},ruby:{cost:8,damage:0},amethyst:{cost:7,damage:0}}},
  'razor-ramon-abdominal-stretch': {printingStats:{base:{cost:7,damage:0},emerald:{cost:6,damage:0},sapphire:{cost:5,damage:0},ruby:{cost:4,damage:0},amethyst:{cost:3,damage:0}}},
  'doink-stump-puller': {printingStats:{base:{cost:7,damage:0},emerald:{cost:6,damage:0},sapphire:{cost:5,damage:0},ruby:{cost:4,damage:0},amethyst:{cost:3,damage:0}}},
  'wristlock': {printingStats:{base:{cost:4,damage:0},emerald:{cost:3,damage:0},sapphire:{cost:2,damage:0},ruby:{cost:1,damage:0},amethyst:{cost:1,damage:0}}},
  'side-headlock': {printingStats:{base:{cost:5,damage:0},emerald:{cost:4,damage:0},sapphire:{cost:3,damage:0},ruby:{cost:2,damage:0},amethyst:{cost:1,damage:0}}},
  'nerve-hold': {printingStats:{base:{cost:6,damage:0},emerald:{cost:5,damage:0},sapphire:{cost:4,damage:0},ruby:{cost:3,damage:0},amethyst:{cost:2,damage:0}}},
  'owen-hart-sharpshooter': {printingStats:{base:{cost:11,damage:0},emerald:{cost:10,damage:0},sapphire:{cost:9,damage:0},ruby:{cost:8,damage:0},amethyst:{cost:7,damage:0}}},
  'full-nelson': {printingStats:{base:{cost:6,damage:0},emerald:{cost:5,damage:0},sapphire:{cost:4,damage:0},ruby:{cost:3,damage:0},amethyst:{cost:2,damage:0}}},
  'rowdy-roddy-piper-sleeper-hold': {printingStats:{base:{cost:10,damage:0},emerald:{cost:9,damage:0},sapphire:{cost:8,damage:0},ruby:{cost:7,damage:0},amethyst:{cost:6,damage:0}}},
  'ted-dibiase-million-dollar-dream': {printingStats:{base:{cost:10,damage:0},emerald:{cost:9,damage:0},sapphire:{cost:8,damage:0},ruby:{cost:7,damage:0},amethyst:{cost:6,damage:0}}},
  'front-facelock': {printingStats:{base:{cost:6,damage:0},emerald:{cost:5,damage:0},sapphire:{cost:4,damage:0},ruby:{cost:3,damage:0},amethyst:{cost:2,damage:0}}},
  'chris-jericho-walls-of-jericho': {printingStats:{base:{cost:11,damage:0},emerald:{cost:10,damage:0},sapphire:{cost:9,damage:0},ruby:{cost:8,damage:0},amethyst:{cost:7,damage:0}}},
  'kurt-angle-ankle-lock': {printingStats:{base:{cost:11,damage:0},emerald:{cost:10,damage:0},sapphire:{cost:9,damage:0},ruby:{cost:8,damage:0},amethyst:{cost:7,damage:0}}},
  'john-cena-stf': {printingStats:{base:{cost:11,damage:0},emerald:{cost:10,damage:0},sapphire:{cost:9,damage:0},ruby:{cost:8,damage:0},amethyst:{cost:7,damage:0}}},
  'kendal-grey-ankle-lock': {printingStats:{base:{cost:8,damage:0},emerald:{cost:7,damage:0},sapphire:{cost:6,damage:0},ruby:{cost:5,damage:0},amethyst:{cost:4,damage:0}}},
  'eddie-guerrero-lasso-from-el-paso': {printingStats:{base:{cost:7,damage:0},emerald:{cost:6,damage:0},sapphire:{cost:5,damage:0},ruby:{cost:4,damage:0},amethyst:{cost:3,damage:0}}},
  'aj-styles-calf-crusher': {printingStats:{base:{cost:9,damage:0},emerald:{cost:8,damage:0},sapphire:{cost:7,damage:0},ruby:{cost:6,damage:0},amethyst:{cost:5,damage:0}}},

  // SHARED_FIVE_TIER_BATCH_17_V11219 — wrestler-specific ordinary offensive Moves; reversals, submissions, Finishers/Trademarks and special-case 619 excluded.
  'tatum-paxley-diving-knee-drop': {printingStats:{base:{cost:6,damage:6},emerald:{cost:6,damage:7},sapphire:{cost:5,damage:8},ruby:{cost:5,damage:8},amethyst:{cost:5,damage:9}}},
  'zilla-fatu-pop-up-samoan-drop': {printingStats:{base:{cost:7,damage:7},emerald:{cost:7,damage:8},sapphire:{cost:6,damage:9},ruby:{cost:6,damage:9},amethyst:{cost:6,damage:10}}},
  'zilla-fatu-running-senton': {printingStats:{base:{cost:6,damage:6},emerald:{cost:6,damage:7},sapphire:{cost:5,damage:8},ruby:{cost:5,damage:8},amethyst:{cost:5,damage:9}}},
  'batista-batista-spinebuster': {printingStats:{base:{cost:7,damage:7},emerald:{cost:7,damage:8},sapphire:{cost:6,damage:9},ruby:{cost:6,damage:9},amethyst:{cost:6,damage:10}}},
  'batista-spear': {printingStats:{base:{cost:7,damage:8},emerald:{cost:7,damage:9},sapphire:{cost:6,damage:10},ruby:{cost:6,damage:10},amethyst:{cost:6,damage:11}}},
  'batista-demon-bomb': {printingStats:{base:{cost:7,damage:7},emerald:{cost:7,damage:8},sapphire:{cost:6,damage:9},ruby:{cost:6,damage:9},amethyst:{cost:6,damage:10}}},
  'jbl-fallaway-slam': {printingStats:{base:{cost:6,damage:6},emerald:{cost:6,damage:7},sapphire:{cost:5,damage:8},ruby:{cost:5,damage:8},amethyst:{cost:5,damage:9}}},
  'jbl-big-boot': {printingStats:{base:{cost:6,damage:6},emerald:{cost:6,damage:7},sapphire:{cost:5,damage:8},ruby:{cost:5,damage:8},amethyst:{cost:5,damage:9}}},
  'eddie-guerrero-hurricanrana': {printingStats:{base:{cost:6,damage:6},emerald:{cost:6,damage:7},sapphire:{cost:5,damage:8},ruby:{cost:5,damage:8},amethyst:{cost:5,damage:9}}},
  'edge-edge-o-matic': {printingStats:{base:{cost:6,damage:6},emerald:{cost:6,damage:7},sapphire:{cost:5,damage:8},ruby:{cost:5,damage:8},amethyst:{cost:5,damage:9}}},
  'edge-impaler-ddt': {printingStats:{base:{cost:7,damage:7},emerald:{cost:7,damage:8},sapphire:{cost:6,damage:9},ruby:{cost:6,damage:9},amethyst:{cost:6,damage:10}}},
  'jeff-hardy-whisper-in-the-wind': {printingStats:{base:{cost:7,damage:7},emerald:{cost:7,damage:8},sapphire:{cost:6,damage:9},ruby:{cost:6,damage:9},amethyst:{cost:6,damage:10}}},
  'jeff-hardy-poetry-in-motion': {printingStats:{base:{cost:6,damage:6},emerald:{cost:6,damage:7},sapphire:{cost:5,damage:8},ruby:{cost:5,damage:8},amethyst:{cost:5,damage:9}}},
  'rob-van-dam-rolling-thunder': {printingStats:{base:{cost:7,damage:7},emerald:{cost:7,damage:8},sapphire:{cost:6,damage:9},ruby:{cost:6,damage:9},amethyst:{cost:6,damage:10}}},
  'rob-van-dam-split-legged-moonsault': {printingStats:{base:{cost:7,damage:7},emerald:{cost:7,damage:8},sapphire:{cost:6,damage:9},ruby:{cost:6,damage:9},amethyst:{cost:6,damage:10}}},
  'aj-styles-pele-kick': {printingStats:{base:{cost:6,damage:6},emerald:{cost:6,damage:7},sapphire:{cost:5,damage:8},ruby:{cost:5,damage:8},amethyst:{cost:5,damage:9}}},
  'aj-styles-ushigoroshi': {printingStats:{base:{cost:7,damage:7},emerald:{cost:7,damage:8},sapphire:{cost:6,damage:9},ruby:{cost:6,damage:9},amethyst:{cost:6,damage:10}}},
  'danhausen-very-nice-knee-vil': {printingStats:{base:{cost:6,damage:6},emerald:{cost:6,damage:7},sapphire:{cost:5,damage:8},ruby:{cost:5,damage:8},amethyst:{cost:5,damage:9}}},
  'joe-hendry-freak-of-nature': {printingStats:{base:{cost:7,damage:7},emerald:{cost:7,damage:8},sapphire:{cost:6,damage:9},ruby:{cost:6,damage:9},amethyst:{cost:6,damage:10}}},
  'joe-hendry-hendry-slam': {printingStats:{base:{cost:7,damage:8},emerald:{cost:7,damage:9},sapphire:{cost:6,damage:10},ruby:{cost:6,damage:10},amethyst:{cost:6,damage:11}}},
