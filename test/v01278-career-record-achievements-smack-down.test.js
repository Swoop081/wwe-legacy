...
import { createProfile, migrateProfile } from "../js/data/profile.js?v=1.1.117";
import { CAREER_ACHIEVEMENTS, recordCareerMatch, refreshCareerAchievements } from "../js/data/career.js?v=1.1.117";
