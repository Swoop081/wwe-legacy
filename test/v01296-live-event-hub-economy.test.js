...
import { activeLiveEventTowers, liveEventTowerState, startLiveEventTower, currentLiveEventTowerOpponent, recordLiveEventTowerMatch, LIVE_EVENT_LENGTH } from '../js/data/live-events.js?v=1.1.117';
import { createProfile } from '../js/data/profile.js?v=1.1.117';
import { STORE_SUPERSTAR_PRICE } from '../js/data/store.js?v=1.1.117';
import { superstars } from '../js/data/superstars.js?v=1.1.117';
import { isLaunchLiveSetId } from '../js/data/release.js?v=1.1.117';
