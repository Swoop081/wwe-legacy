...
import { moveEligibility, canPlayAction } from '../js/engine/rules.js?v=1.1.114';
import { evaluateDeckHealth } from '../js/data/deck-health.js?v=1.1.114';
...
test('v0.13.0 approved first-25 balance values are locked', () => {
  ...
  assert.equal(charlotte.ability.trigger.maxUses, 3); // superseded by v0.14.26
