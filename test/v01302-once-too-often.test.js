...
import { deckIds, decks } from '../js/data/decks.js?v=0.14.14';
import { superstars } from '../js/data/superstars.js?v=0.14.14';
import { MatchEngine } from '../js/engine/MatchEngine.js?v=0.14.14';
import { counterEligibility } from '../js/engine/rules.js?v=0.14.14';
import { createProfile, migrateProfile, totalOwnedCopies, PROFILE_VERSION } from '../js/data/profile.js?v=0.14.14';
