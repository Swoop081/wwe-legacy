...
import { DECK_LAB_CATEGORIES, categoryForCard } from '../js/data/deck-builder.js?v=1.1.132';
...
import { canPlayAction, canPlayPinEscape } from '../js/engine/rules.js?v=1.1.132';
