...
import { moveEligibility } from '../js/engine/rules.js?v=1.1.100';
import { createProfile, grantSuperstarUnlockPackage, totalOwnedCopies } from '../js/data/profile.js?v=1.1.100';
