...
import { cpuDecision } from '../js/ai/WrestlingAI.js?v=1.0.1';
import { allGameplayCards } from '../js/data/content.js?v=1.0.1';
import { collectionCards } from '../js/data/collection.js?v=1.0.1';
import { reconstructCurrentPlayPile } from '../js/ui/play-pile.js?v=1.0.1';
...
import { activeLiveEventTowers, LIVE_EVENT_WIN_UP } from '../js/data/live-events.js?v=1.0.1';
import { isPlayerVisibleSuperstar } from '../js/data/release.js?v=1.0.1';
import { layeredCardArtFor, finishedCardArtFor } from '../js/data/artwork.js?v=1.0.1';
