...
import { activeLiveEventTowers, LIVE_EVENT_WIN_UP } from '../js/data/live-events.js?v=1.0.2';
import { isPlayerVisibleSuperstar } from '../js/data/release.js?v=1.0.2';
import { layeredCardArtFor, finishedCardArtFor } from '../js/data/artwork.js?v=1.0.2';
