...
import { createProfile, grantSuperstarUnlockPackage } from '../js/data/profile.js?v=1.1.101';
import { collectionCards } from '../js/data/collection.js?v=1.1.101';
import { buildBestOwnedRecommendedDraft, enforceOwnedDraft, recommendedDeckDraft, validateDeckDraft, ownedTotal, cardEligibilityForSuperstar } from '../js/data/deck-builder.js?v=1.1.101';
