...
import { autoCounterEligibility, canPlaySpecial, counterEligibility, moveEligibility } from '../js/engine/rules.js?v=1.1.24';
import { legalForSuperstar } from '../js/data/deck-builder.js?v=1.1.24';
