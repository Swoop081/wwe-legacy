...
import { allGameplayCards, linkedGameplayCards } from '../js/data/content.js?v=1.1.130';
...
import { canPlaySpecial, moveEligibility } from '../js/engine/rules.js?v=1.1.130';
import { CARD_NUMBER_BY_ID, CARD_IDS_BY_SET } from '../js/data/card-number-manifest.js?v=1.1.130';
