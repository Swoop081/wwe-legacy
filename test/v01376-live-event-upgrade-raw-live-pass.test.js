...
import { activeLiveEventTowers, startLiveEventTower, RAW_LIVE_EVENT } from '../js/data/live-events.js?v=1.1.23';
import { counterEligibility } from '../js/engine/rules.js?v=1.1.23';
