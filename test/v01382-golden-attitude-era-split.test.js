...
import { CARD_NUMBER_BY_ID, CARD_IDS_BY_SET } from '../js/data/card-number-manifest.js?v=0.14.08';
import { LAUNCH_LIVE_SET_IDS } from '../js/data/release.js?v=0.14.08';
import { MatchEngine } from '../js/engine/MatchEngine.js?v=0.14.08';
import { cpuDecision } from '../js/ai/WrestlingAI.js?v=0.14.08';
await import('../js/data/superstar-nameplates.js?v=0.14.08');
