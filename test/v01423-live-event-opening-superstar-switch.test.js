...
import { isPlayerVisibleSuperstar } from '../js/data/release.js?v=1.0.2';
import { activeLiveEventTowers, startLiveEventTower, changeLiveEventTowerSuperstar, currentLiveEventTowerOpponent, recordLiveEventTowerMatch } from '../js/data/live-events.js?v=1.0.2';
