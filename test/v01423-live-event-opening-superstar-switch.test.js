...
import { activeLiveEventTowers, startLiveEventTower, changeLiveEventTowerSuperstar, currentLiveEventTowerOpponent, recordLiveEventTowerMatch } from '../js/data/live-events.js?v=1.1.131';
