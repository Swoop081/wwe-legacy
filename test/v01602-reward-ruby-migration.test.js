...
import { addOwnedCard, createProfile, migrateProfile, ownedCount, PROFILE_VERSION } from '../js/data/profile.js?v=1.1.116';
import { applyCardTier, cardPrintingTiers, fixedPrintingTierFor } from '../js/data/variants.js?v=1.1.116';
