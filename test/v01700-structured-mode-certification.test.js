...
import { isPlayerVisibleSuperstar, isUnreleasedSetId, isLaunchLiveSetId } from '../js/data/release.js?v=1.1.86';
...
} from '../js/data/championship-road.js?v=1.1.86';
import {
  LIVE_EVENT_LENGTH,
...
} from '../js/data/live-events.js?v=1.1.86';
