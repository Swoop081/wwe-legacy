...
import { MERCH_ITEMS } from '../js/data/merch.js?v=1.1.22';
import { SUPERSTAR_VARIANTS } from '../js/data/superstar-variants.js?v=1.1.22';
import { canonicalCardImagePath, canonicalBasePlatePath } from '../js/data/artwork.js?v=1.1.22';
