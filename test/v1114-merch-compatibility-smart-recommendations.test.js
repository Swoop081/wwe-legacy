...
import { GENERIC_MERCH, grantMerch, equipMerch, activeMerchItem, merchEligibilityForSuperstar, merchMatchModifier } from '../js/data/merch.js?v=1.1.30';
import { findPackUpgrades, applyUpgrade, bestMerchTarget } from '../js/data/deck-assistant.js?v=1.1.30';
