...
test("v1.1.22 linked animated URLs survive CORS-blocked raw fetches",()=>{
...
test("v1.1.22 Studio persists and restores one linked animation URL per eligible card",()=>{
...
test("v1.1.22 live cards prefer the linked URL and fall back to packaged WebP then GIF",()=>{
...
test("v1.1.22 linked mode keeps raw export optional rather than failing the URL workflow",()=>{
