...
import { createProfile, STARTER_CHOICES, claimWelcomeSuperstarPack, welcomeSuperstarState, ownedCount } from "../js/data/profile.js?v=1.1.99";
import { superstarPackCandidates, SUPERSTAR_PACK_SIZE } from "../js/data/superstar-packs.js?v=1.1.99";
