...
import { seasonExclusiveSuperstars, ACTIVE_REWARD_SUPERSTAR_IDS, REWARD_PRINTING_TIER } from "../js/data/season-exclusive.js?v=1.1.132";
import { cardPrintingTiers } from "../js/data/variants.js?v=1.1.132";
