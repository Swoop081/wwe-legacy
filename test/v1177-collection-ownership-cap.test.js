...
import { addOwnedCard, totalOwnedCopies, underTierOwnershipCap, cardTotalOwnershipCap } from '../js/data/profile.js?v=1.1.86';
import { CARD_TIERS } from '../js/data/variants.js?v=1.1.86';
