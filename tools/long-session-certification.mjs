...
import { isPlayerReleasedSetId } from '../js/data/release.js?v=1.0.1';
...
import { createProfile, saveProfile, loadProfile, PROFILE_KEY } from '../js/data/profile.js?v=1.0.1';
import { recordCareerMatch } from '../js/data/career.js?v=1.0.1';
