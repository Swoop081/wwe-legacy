...
import { STARTER_CHOICES, WELCOME_SUPERSTAR_SET_IDS, createProfile, claimWelcomeSuperstar, ownedCount, DEFAULT_PLAYER_ENTRANCE_ID, STARTING_MOMENTUM_COPIES } from '../js/data/profile.js?v=0.18.00';
import { buildPlayableDeck } from '../js/data/deck-assistant.js?v=0.18.00';
import { claimAllSeasonTiers, seasonState } from '../js/data/seasons.js?v=0.18.00';
