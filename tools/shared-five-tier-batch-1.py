...
assert marker in s
stamp='// SHARED_FIVE_TIER_BATCH_1_V11202'
entries="""  // SHARED_FIVE_TIER_BATCH_1_V11202 — authored global curves; preserve each card's existing requirements/effects.
